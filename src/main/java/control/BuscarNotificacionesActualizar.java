...
@WebServlet("/BuscarNotificacionesActualizar")
public class BuscarNotificacionesActualizar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("buscar".equals(action)) {
            ...
            if (!notificaciones.isEmpty()) {
                ...
                request.getRequestDispatcher("actualizarNotificacionBuscar.jsp").forward(request, response);
            } else {
