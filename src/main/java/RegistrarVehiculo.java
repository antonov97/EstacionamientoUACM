...
public class RegistrarVehiculo extends HttpServlet {
    ...
    // Lista de modelos y marcas de vehículos
    private static final String[] modelos = {"Modelo 1", "Modelo 2", "Modelo 3"};
    private static final String[] marcas = {"Marca 1", "Marca 2", "Marca 3"};
